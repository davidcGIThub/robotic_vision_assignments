...
number_of_inner_column_corners = 9
...
for file in files:
    ...
    # cv.waitKey(0)
image = cv.imread(image_directory + "/checkerboard3.jpg", cv.IMREAD_GRAYSCALE)
...
np. save("intrinsic_parameters_home.npy", camera_matrix)
np. save("distortion_parameters_home.npy", distortion_coeficients)
