...
close_difference_image = np.abs(close_image - corrected_close_image)
far_difference_image =  np.abs(far_image - corrected_far_image)
turned_difference_image = np.abs(turned_image - corrected_turned_image)
